...
export function createProgram(): Command {
  ...
  program
    ...
    .option("--platform <name>", "Platform tag: openclaw, claude-code, codex, plaud")
  ...
  program
    ...
    .option("--platform <name>", "Session platform: openclaw, claude-code, codex, plaud, mtime")
  ...
  program
    ...
    .option("--platform <name>", "Scope consolidation to platform: openclaw, claude-code, codex, plaud")
