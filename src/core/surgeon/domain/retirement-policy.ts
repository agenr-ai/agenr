...
import type { SurgeonRunAction } from "./action-types.js";
 ...
 */
const SURGEON_RETIREMENT_SAME_RUN_SUPPRESSION_ACTION_TYPES: Array<Extract<SurgeonRunAction["actionType"], "skip" | "retire" | "update_entry">> = [
  "skip",
  "retire",
  "update_entry",
];
 ...
 */
const SURGEON_RETIREMENT_RECENT_EVALUATION_ACTION_TYPES: Array<Extract<SurgeonRunAction["actionType"], "skip" | "retire" | "update_entry">> = [
  "skip",
  "retire",
  "update_entry",
];
 ...
 */
export interface SurgeonRetirementPolicyCandidate {
  id: string;
  subject: string;
  type: string;
  importance: number;
 ...
 */
export function isActionableRetirementCandidate(candidate: Pick<SurgeonRetirementPolicyCandidate, "type" | "importance" | "expiry" | "recallCount">): boolean {
  return (
 ...
 */
export function compareRetirementCandidates(left: SurgeonRetirementPolicyCandidate, right: SurgeonRetirementPolicyCandidate): number {
 ...
 */
export function getRetirementCandidatePriorityTier(candidate: Pick<SurgeonRetirementPolicyCandidate, "subject" | "type" | "importance" | "expiry">): number {
