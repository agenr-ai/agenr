...
const CLAIM_EXTRACTION_SYSTEM_PROMPT = [
  ...
  "  WRONG: \"jim pet\" -> RIGHT: \"jim\"",
  "  WRONG: \"agenr extraction model\" -> RIGHT: \"agenr\"",
  "  WRONG: \"system architecture\" -> RIGHT: \"system\"",
  "  If the entry is about Jim's pet, entity is \"jim\", attribute is \"pet\".",
  ...
  "  If subject says \"Duke breed\", the entity is likely \"duke\".",
  ...
  "  \"Jim works at Loopback Health\" -> extract (clear fact)",
  "",
  "WRONG to return no_claim:",
  "  \"Jim works at Loopback Health as Sr Director of Engineering\"",
  "  (clear primary claim: jim works_at loopback health)",
  "",
  ...
  "",
  "  Entry: \"Jim works at Loopback Health as Sr Director of Engineering\"",
  "  -> subject_entity: jim, subject_attribute: employer, predicate: works_at, object: loopback health, confidence: 0.9",
  "",
  "  Entry: \"Jim values alone time and continuous improvement\"",
  "  -> subject_entity: jim, subject_attribute: values, predicate: values, object: alone time and continuous improvement, confidence: 0.8",
  "",
  "  Entry: \"Jim dislikes em-dashes and prefers hyphens\"",
  "  -> subject_entity: jim, subject_attribute: formatting, predicate: dislikes, object: em-dashes, confidence: 0.85",
  "",
  ...
  "",
  "  Entry: \"Jim has a dog named Duke\"",
  "  -> subject_entity: jim, subject_attribute: pet, predicate: has, object: duke, confidence: 0.9",
  "",
