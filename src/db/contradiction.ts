...
const CONTRADICTION_JUDGE_SYSTEM_PROMPT = [
  ...
  "  Example: weight changed from 200 to 180, preference changed from npm to pnpm.",
  '- "contradicts": Entries make conflicting claims that cannot both be true',
  "  AND it is unclear which is correct.",
  "  Example: two sources disagree on a fact with no clear winner.",
  '- "coexists": Entries are about related topics but both can be true.',
  '  Example: "likes Python" and "prefers TypeScript for new projects".',
  ...
  "- If both entries could be true simultaneously in different contexts,",
  '  that is "coexists".',
  '- Only use "contradicts" when the entries genuinely cannot both be true',
  ...
  '- "unrelated" is for entries that happen to share keywords but are about',
