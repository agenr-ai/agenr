...
import {
  ...
  countUnsynthesizedEpisodes,
  getDreamHealthStats,
  listActiveClaimKeyContext,
  listReconcileDurables,
  listSessionHostStoreDurables,
  listUnsynthesizedEpisodeEvidence,
  markEpisodesSynthesized,
...
export function createDreamPort(executor: SqlExecutor): DreamPort {
  return {
    ...
    getLastCompletedRun: async () => getLastCompletedDreamRun(executor),
    ...
    getProposalStagingActionDetails: async (proposalId) => getDreamProposalStagingActionDetails(executor, proposalId),
    ...
    listUnsynthesizedEpisodeEvidence: async (options) => listUnsynthesizedEpisodeEvidence(executor, options),
    countUnsynthesizedEpisodes: async (project) => countUnsynthesizedEpisodes(executor, project),
    markEpisodesSynthesized: async (input) => markEpisodesSynthesized(executor, input),
